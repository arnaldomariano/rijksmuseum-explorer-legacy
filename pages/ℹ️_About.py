...
st.write(
    ...
    "- These files are used only so your selection and notes can be restored when "
    "you reopen the app.\n"
...
st.caption(
    ...
    "selection, then review and export it on the **My selection** page."
)
...
st.write(
    ...
    "3. Each card shows the image, title, artist, date (when available) and object ID.\n"
    "4. Use **“More details”** inside a card to see extra metadata such as long title, "
    "object type, materials, techniques and production place.\n"
    "5. Use **“View details”** to open a larger image and a structured list of metadata, "
    "together with a dedicated space for your **research notes**.\n"
    "6. Cards that already have notes display a small 📝 indicator so you can quickly "
    "spot annotated artworks.\n"
    "7. At any time, you can click **“Clear my entire selection”** to start over with an "
    "empty collection."
)
...
st.write(
    "1. On the **My selection** page, use the checkbox **“Select for comparison”** "
    "below the artworks you want to compare.\n"
    "2. Select **exactly two** artworks.\n"
    "3. Click **“Compare selected artworks”** to open a side-by-side comparison, showing:\n"
    "   - images of both artworks,\n"
    "   - titles and artists,\n"
    "   - dates (when available),\n"
    "   - object IDs and links to the official pages.\n"
    "4. This is useful, for example, to compare different views of the same city, "
    "self-portraits across time or variations of the same subject."
)
...
st.write(
    ...
    "basic metadata and (when present) your research notes.\n"
...
st.write(
    ...
    "- You can combine this app with your own spreadsheets or notebooks to build small "
    "research projects or classroom activities."
)
